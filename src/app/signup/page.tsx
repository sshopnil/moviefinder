...
function SubmitButton() {
    ...
    return (
        <button
            type="submit"
            disabled={pending}
            className="w-full bg-white text-black font-semibold py-3 rounded-xl hover:bg-gray-200 transition-colors flex items-center justify-center disabled:opacity-50"
        >
        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            <GlassCard className="w-full max-w-md p-8 space-y-6">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-gray-400">Join MovieFinder today</p>
                </div>
                ...
                <form action={formAction} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        />
                        {state?.error?.name && <p className="text-red-400 text-xs">{state.error.name[0]}</p>}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        {state?.error?.email && <p className="text-red-400 text-xs">{state.error.email[0]}</p>}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            placeholder="••••••••"
                        />
                        {state?.error?.password && <p className="text-red-400 text-xs">{state.error.password[0]}</p>}
                    </div>
